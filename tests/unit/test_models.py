...
class UsetTest(unittest.TestCase):
    ...
    def test_new_user_print_conversion(self):
        ...
        THEN check the email, password, authenticated, and active fields are defined correctly
        """
    ...
    def test_is_user_id_protected(self):
        ...
        self.assertEqual(str(context.exception), "property 'id' of 'User' object has no setter")
    ...
    def test_user_memo_update(self):
        ...
        assert not self.new_user.memo is None
    ...
    def test_user_email_verified(self):
        ...
        assert not self.new_user.email_verified_at is None
    ...
    def test_new_user_is_updated_at(self):
        ...
        assert not self.new_user.updated_at is None
